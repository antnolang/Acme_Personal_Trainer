...
<form:form action="educationRecord/trainer/edit.do" modelAttribute="educationRecord">
	...
	<jstl:choose>
		<jstl:when test="${curriculumId ne null}">
			<acme:cancel code="educationRecord.cancel" url="curriculum/display.do?curriculumId=${curriculumId}"/>
		</jstl:when>
		<jstl:otherwise>
			<acme:cancel code="educationRecord.cancel" url="educationRecord/backCurriculum.do?educationRecordId=${educationRecord.id}"/>
		</jstl:otherwise>
	</jstl:choose>
</form:form>
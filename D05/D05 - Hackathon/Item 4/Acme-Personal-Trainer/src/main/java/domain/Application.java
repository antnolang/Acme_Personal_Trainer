...
@Table(indexes = {
	@Index(columnList = "working_out, status"), @Index(columnList = "working_out, customer"), @Index(columnList = "customer, status"), @Index(columnList = "customer, working_out, status")
})
